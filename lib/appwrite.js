...
// Search Query - Add or Remove image collection ID if needed.
export const searchPosts = async (query) => {
  try {
    const posts = await databases.listDocuments(
      ...
      videoCollectionId,
      imageCollectionId,
      [Query.search('title', query)]  // You can change queries here if needed (or revert back to the one above)
    );

...
export const createGallery = async ({ title, thumbnail, assets, assetType, userId }) => {
  try {
    // Upload the thumbnail using the updated uploadFile logic
    const thumbnailUrl = await uploadFile(thumbnail, 'image/jpeg');

    // Upload each asset using the updated uploadFile logic
